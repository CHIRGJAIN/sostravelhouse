...
export const categories = [
  { name: "Domestic", icon: "🏠", count: 45 },
  { name: "International", icon: "✈️", count: 32 },
  { name: "Honeymoon", icon: "💕", count: 18 },
  { name: "Family", icon: "👨‍👩‍👧‍👦", count: 24 },
  { name: "Adventure", icon: "🏔️", count: 15 },
  { name: "Group Tours", icon: "👥", count: 20 },
  { name: "Weekend Getaways", icon: "🌴", count: 12 },
  { name: "Luxury", icon: "👑", count: 8 },
];
...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    itineraryDays: [
      ...
      { day: 2, title: "Iconic Paris", description: "Eiffel Tower summit, Champ de Mars, Arc de Triomphe, Champs-Élysées.", meals: ["Breakfast"] },
      { day: 3, title: "Art & Culture", description: "Louvre Museum, Tuileries Garden, Musée d'Orsay, Latin Quarter.", meals: ["Breakfast"] },
      ...
      { day: 5, title: "Montmartre & More", description: "Sacré-Cœur, artists' square, Moulin Rouge area. Farewell dinner.", meals: ["Breakfast", "Dinner"] },
...
export const reviews: Review[] = [
  { id: 1, tourId: 1, name: "Priya Sharma", avatar: "PS", rating: 5, date: "2026-01-15", comment: "Absolutely loved the Goa trip! The hotel was amazing and the sunset cruise was the highlight. ENGEE HOLIDAYS made everything seamless.", destination: "Goa" },
  ...
  { id: 5, tourId: 5, name: "Meera Krishnan", avatar: "MK", rating: 4, date: "2025-12-15", comment: "Thailand was fun-packed! Phi Phi Islands were breathtaking. The team was very helpful. Would book with ENGEE again!", destination: "Thailand" },
...
export const blogPosts: BlogPost[] = [
  {
    ...
    author: "Vineet Kumar", date: "2026-01-20", readTime: "8 min", tags: ["Honeymoon", "India", "Travel Tips"],
    image: tourImages[6], featured: true,
  },
  {
    id: 2, slug: "budget-travel-guide-southeast-asia", title: "Budget Travel Guide: Southeast Asia Under ₹50,000",
  ...
  },
  {
    ...
    author: "Vineet Kumar", date: "2025-12-20", readTime: "5 min", tags: ["Winter", "India", "Seasonal"],
    image: tourImages[3], featured: false,
  },
];

export const coupons: Coupon[] = [
  { code: "ENGEE10", discount: 10, type: "percent", minAmount: 20000, description: "10% off on orders above ₹20,000", valid: true },
  { code: "FIRST5000", discount: 5000, type: "flat", minAmount: 30000, description: "Flat ₹5,000 off on your first booking", valid: true },
...
export const teamMembers = [
  ...
  { name: "Sneha Kapoor", role: "Marketing Director", bio: "Bringing the ENGEE HOLIDAYS experience to travelers worldwide.", avatar: "SK" },
];

export const faqs = [
  { q: "How do I book a tour with ENGEE HOLIDAYS?", a: "You can browse our tours on the website, select your preferred package, choose dates and travelers, and proceed to booking. Alternatively, call us at 9811622000 or fill out the custom trip planner form." },
