  ...
  return (
    <div className="min-h-screen bg-background pb-24 lg:pb-0">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Tabs defaultValue="overview" className="mt-8">
              ...
              <TabsContent value="overview" className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
                ...
                <p>Available months: {tour.availableMonths.join(", ")}. Maximum group size: {tour.maxGroupSize} travelers. Next available date: {formatDate(tour.nextAvailableDate)}.</p>
              </TabsContent>
          ...
          <aside className="hidden w-80 shrink-0 lg:block">
            <div className="sticky top-24 space-y-6 card-surface p-6">
              <div>
                {tour.dealPercent > 0 && (
                  <span className="text-sm text-muted-foreground line-through">{formatINR(Math.round(tour.pricePerPerson / (1 - tour.dealPercent / 100)))}</span>
                )}
              ...
              <div className="space-y-1 rounded-xl bg-muted p-3">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>Next: {formatDate(selectedDate)}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <div className="border-t border-border pt-4">
                ...
                <div className="mt-1 flex justify-between text-sm text-muted-foreground">
                  ...
                  <span>{formatINR(Math.round(estimatedTotal * 0.05))}</span>
                </div>
                <div className="mt-2 flex justify-between font-heading text-lg font-bold text-foreground">
                  <span>Total</span>
                  <span>{formatINR(Math.round(estimatedTotal * 1.05))}</span>
                </div>
              </div>
      ...
      <div className="fixed bottom-14 left-0 right-0 z-40 border-t border-border bg-card/95 px-4 py-3 backdrop-blur-xl lg:hidden">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-lg font-bold text-foreground">{formatINR(estimatedTotal)}</p>
