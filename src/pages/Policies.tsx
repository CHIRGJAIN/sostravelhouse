...
export default function Policies() {
  const sections = [
    { id: "cancellation", title: "Cancellation Policy", content: "Cancellations made 30+ days before departure: 90% refund. 15-30 days before departure: 50% refund. Less than 15 days before departure: No refund. All cancellations must be communicated in writing via email to hello@jayambeholidays.com. Processing of refunds takes 7-10 business days." },
    { id: "terms", title: "Terms & Conditions", content: "By booking with Jayambe Holidays, you agree to our terms. All tour prices are per person on twin sharing basis unless stated otherwise. Prices are subject to change without prior notice due to currency fluctuations, fuel surcharges, or government taxes. Valid passport and necessary visas are the responsibility of the traveler. Jayambe Holidays reserves the right to alter itineraries due to unforeseen circumstances." },
