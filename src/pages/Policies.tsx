export default function Policies() {
  const sections = [
    { id: "cancellation", title: "Cancellation Policy", content: "Cancellations made 30+ days before departure: 90% refund. 15-30 days before departure: 50% refund. Less than 15 days before departure: No refund. All cancellations must be communicated in writing via email to vineet@engeeholidays.com. Processing of refunds takes 7-10 business days." },
    { id: "terms", title: "Terms & Conditions", content: "By booking with ENGEE HOLIDAYS, you agree to our terms. All tour prices are per person on twin sharing basis unless stated otherwise. Prices are subject to change without prior notice due to currency fluctuations, fuel surcharges, or government taxes. Valid passport and necessary visas are the responsibility of the traveler. ENGEE HOLIDAYS reserves the right to alter itineraries due to unforeseen circumstances." },
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="gradient-primary py-16"><div className="container mx-auto px-4 text-center"><h1 className="font-heading text-3xl font-bold text-primary-foreground">Policies</h1></div></div>
