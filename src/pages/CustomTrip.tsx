...
export default function CustomTrip() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageHeader title="Plan Your Custom Trip" subtitle="Tell us your preferences and we will craft a tailored itinerary." />
      <div className="container mx-auto max-w-2xl px-4 py-8">
        ...
        <div className="card-surface p-6 space-y-4">
          ...
          {step === 1 && <><Field label="Adults" name="adults" type="number" /><Field label="Children" name="children" type="number" /><Field label="Budget per person (INR)" name="budget" type="number" /></>}
          {step === 2 && (
