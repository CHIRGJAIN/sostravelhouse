...
export default function About() {
  return (
    <div className="min-h-screen bg-background">
      <div className="gradient-primary py-16"><div className="container mx-auto px-4 text-center"><h1 className="font-heading text-3xl font-bold text-primary-foreground md:text-4xl">About ENGEE HOLIDAYS</h1><p className="mt-2 text-primary-foreground/80">Your trusted partner in travel since 2005</p></div></div>
